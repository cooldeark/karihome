...
<header>
    ...
    <div class="WRAPPER roster_W">
        <!---------參加名單----------------------->
        <section class="roster">
              <div class="group">
                  <div class="title">
                      <img src="./images/c4_roster.png" alt="參加名單">
                  </div>
                  <div class="box ">
                    <div class="roster_text_box scrollbar">
                      @foreach($showOnView as $index=>$value)
                      <div class="roster_list " style="text-align: center;">
                        <span> {{$value['name']}} </span><span> {{$value['identityID']}} </span><span> {{$value['phone']}} </span>
                      </div>
                      @endforeach
                    </div>
                  </div>
              ...
              <div class="roster_goat">
                <img src="./images/c4_roster_goat.png" alt="羊">
